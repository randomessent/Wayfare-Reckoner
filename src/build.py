...
`wayfare-app.html` at the top of the repo — one self-contained file that opens
in any browser with no server and no network. Everything the app needs, the
gazetteer and the grids included, is carried inside it, which is why it is
about ten megabytes.
...
def main():
    ...
    dest = os.path.join(ROOT, "wayfare-app.html")
